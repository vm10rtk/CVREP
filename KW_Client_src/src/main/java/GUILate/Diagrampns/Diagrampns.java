...
public class Diagrampns extends JFrame {

    private static final long serialVersionUID = 1L;
    public int admins ;
    public int users ;
    public List<ProductsAndService> productsAndServiceList = new ArrayList<>();
    static {
    ...
    public Diagrampns(String title,List<ProductsAndService> pns,Frame frame) {
        super(title);
        this.productsAndServiceList = pns;
...
//                }
    ...
    private CategoryDataset createDataset() {
        ...
        for(int i=0;i<productsAndServiceList.size();i++){
        dataset.addValue(productsAndServiceList.get(i).getSoldcount()*productsAndServiceList.get(i).getPrice(), productsAndServiceList.get(i).getName(), "Админ");}
